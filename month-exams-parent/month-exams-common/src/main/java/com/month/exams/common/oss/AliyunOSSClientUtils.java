package com.month.exams.common.oss;
...
public class AliyunOSSClientUtils {
	...
	// accessKey
	private String accessKeyId = "LTAI4FvyxWd7e4UZZEq8bysj";
	private String accessKeySecret = "tbvdgKdyz7117hbfuKyfWwxgVq3oSm";
	// 空间
	private String bucketName = "aisile-imageup";
	// 文件存储目录
